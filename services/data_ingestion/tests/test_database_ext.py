...
class TestInitPriceDataExt(unittest.TestCase):
    ...
    def test_insert_companies_and_fetch(self):
        companies = [
            {'CompanyID': 'C1', 'Ticker': 'T1', 'Name': 'N1', 'SectorID': 1, 'PanelID': 1, 'MarketID': 1},
            {'CompanyID': 'C2', 'Ticker': 'T2', 'Name': 'N2', 'SectorID': 2, 'PanelID': 2, 'MarketID': 2}
        ]
    ...
    def test_insert_and_fetch_price_data(self):
        records = [
            {'date': '2023-01-01', 'j_date': '1401-10-11', 'adj_open': 100, 'adj_high': 105, 'adj_low': 95, 'adj_close': 102, 'adj_final': 102, 'adj_volume': 1000, 'sector_id': 1, 'ticker': 'T1', 'company_id': 'C1'},
            {'date': '2023-01-02', 'j_date': '1401-10-12', 'adj_open': 101, 'adj_high': 106, 'adj_low': 96, 'adj_close': 103, 'adj_final': 103, 'adj_volume': 1100, 'sector_id': 2, 'ticker': 'T2', 'company_id': 'C2'}
        ]
