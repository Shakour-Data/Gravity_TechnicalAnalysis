...
class TestDataFetcher(unittest.TestCase):
    ...
    def test_fetch_company_price_history_success(self, mock_get_price):
        ...
        result = DataFetcher.fetch_company_price_history(
            self.sample_company, "1400-01-01", "1401-01-01"
        )
    ...
    def test_fetch_sector_index_history_success(self, mock_get_sector):
        ...
        result = DataFetcher.fetch_sector_index_history(
            self.sample_sector, "1400-01-01", "1401-01-01"
        )
        self.assertIsInstance(result, list)
        self.assertGreater(len(result), 0)
