...
class TestInitPriceData(unittest.TestCase):
    ...
    def test_create_tables(self):
        ...
        try:
            ...
            expected_tables = ['price_data', 'companies', 'sectors', 'markets', 'panels', 'last_updates']
    ...
    def test_insert_price_data_tuple(self):
        records = [('2023-01-01', '1401-01-01', 100.0, 110.0, 90.0, 105.0, 105.0, 1000.0, 'TEST', 'TEST001', None)]
        init_price_data.insert_price_data(records)
        conn = sqlite3.connect(self.test_db)
        try:
            cursor = conn.cursor()
    ...
    def test_update_price_data_sectors(self):
        ...
        init_price_data.insert_price_data([('2023-01-01', '1401-01-01', 100.0, 110.0, 90.0, 105.0, 105.0, 1000.0, 'TEST', 'TEST001', None)])
