...
class TSEBaseInfoExtractor:
    def __init__(self, output_dir: str = "BasicTseInformation") -> None:
        ...
        self.markets: Optional[pd.DataFrame] = None
        self.panels: Optional[pd.DataFrame] = None
        self.sectors: Optional[pd.DataFrame] = None
        self.subsectors: Optional[pd.DataFrame] = None
        self.companies: Optional[List[Dict[str, Any]]] = None
    ...
    def validate_data(self):
        ...
        try:
            ...
            required_files = ['markets.json', 'panels.json', 'sectors.json', 'subsectors.json', 'companies.json']
...
def load_tse_base_markets(data_dir: str = 'BasicTseInformation') -> Optional[List[Dict[str, Any]]]:
    """Load TSE markets data from JSON file."""
    return load_json_file(os.path.join(data_dir, 'markets.json'))

def load_tse_base_panels(data_dir: str = 'BasicTseInformation') -> Optional[List[Dict[str, Any]]]:
    """Load TSE panels data from JSON file."""
    return load_json_file(os.path.join(data_dir, 'panels.json'))

def load_tse_base_sectors(data_dir: str = 'BasicTseInformation') -> Optional[List[Dict[str, Any]]]:
    """Load TSE sectors data from JSON file."""
    return load_json_file(os.path.join(data_dir, 'sectors.json'))

def load_tse_base_subsectors(data_dir: str = 'BasicTseInformation') -> Optional[List[Dict[str, Any]]]:
    """Load TSE subsectors data from JSON file."""
    return load_json_file(os.path.join(data_dir, 'subsectors.json'))

def load_tse_base_companies(data_dir: str = 'BasicTseInformation') -> Optional[List[Dict[str, Any]]]:
    """Load TSE companies data from JSON file."""
    return load_json_file(os.path.join(data_dir, 'companies.json'))

def load_tse_base_master_structure(data_dir: str = 'BasicTseInformation') -> Optional[Dict[str, Any]]:
