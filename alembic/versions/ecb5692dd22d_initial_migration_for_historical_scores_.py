...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('volume_score', sa.Numeric(precision=10, scale=4), nullable=False, server_default=sa.text('0')),
        sa.Column('volatility_score', sa.Numeric(precision=10, scale=4), nullable=False, server_default=sa.text('0')),
        sa.Column('cycle_score', sa.Numeric(precision=10, scale=4), nullable=False, server_default=sa.text('0')),
        sa.Column('support_resistance_score', sa.Numeric(precision=10, scale=4), nullable=False, server_default=sa.text('0')),
    ...
    op.create_index('idx_daily_dim_symbol_ts', 'daily_dimension_scores', ['symbol', 'ts'], unique=False, schema='tech_analysis')
    op.create_index('idx_daily_dim_dimension', 'daily_dimension_scores', ['dimension'], unique=False, schema='tech_analysis')
    ...
    op.create_table(
        ...
        sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=True),
        sa.UniqueConstraint('symbol', 'timeframe', 'ts', 'dimension', 'indicator_name', name='uq_daily_indicator'),
        schema='tech_analysis',
    )
    op.create_index('idx_daily_ind_symbol_ts', 'daily_indicator_values', ['symbol', 'ts'], unique=False, schema='tech_analysis')
    op.create_index('idx_daily_ind_dimension', 'daily_indicator_values', ['dimension'], unique=False, schema='tech_analysis')
    op.create_index('idx_daily_ind_indicator', 'daily_indicator_values', ['indicator_name'], unique=False, schema='tech_analysis')
...
def downgrade() -> None:
    op.drop_index('idx_daily_ind_indicator', table_name='daily_indicator_values', schema='tech_analysis')
    op.drop_index('idx_daily_ind_dimension', table_name='daily_indicator_values', schema='tech_analysis')
    op.drop_index('idx_daily_ind_symbol_ts', table_name='daily_indicator_values', schema='tech_analysis')
    op.drop_table('daily_indicator_values', schema='tech_analysis')

    op.drop_index('idx_daily_dim_dimension', table_name='daily_dimension_scores', schema='tech_analysis')
    op.drop_index('idx_daily_dim_symbol_ts', table_name='daily_dimension_scores', schema='tech_analysis')
