...
### 🚀 Release: "Major Project Restructuring & Test Enhancement"

**خلاصه:** بازسازی اساسی ساختار پروژه و بهبود گسترده زیرساخت تست با تمرکز بر کیفیت کد و قابلیت نگهداری.

### ✅ تغییرات کلیدی

#### 🏗️ بازسازی ساختار پروژه
- **Migration to src/:** انتقال کامل کد به ساختار استاندارد `src/gravity_tech/`
  - انتقال 50+ فایل از root به `src/`
  - بهبود سازماندهی ماژول‌ها
  - سازگاری با PEP 517/518
- **Database Integration:** اضافه شدن سیستم دیتابیس کامل
  - PostgreSQL/SQLite fallback
  - Historical data storage
  - Schema migrations با Alembic

#### 🧪 بهبود زیرساخت تست
- **Test Suite Expansion:** اضافه شدن 13 فایل تست جامع جدید
  - تست‌های کامل برای indicators (cycle, momentum, trend, volume)
  - تست‌های integration برای سیستم ترکیبی
  - پوشش 76%+ کد
- **Test Infrastructure:** بهبود `conftest.py` با 6 fixture جهانی
- **Mathematical Validation:** اضافه شدن تست‌های اعتبارسنجی ریاضی

#### 📚 مستندات و سازماندهی
- **Documentation Archive:** انتقال مستندات قدیمی به `docs/archive/`
- **Release Notes:** اضافه شدن فایل‌های release notes برای نسخه‌های قبلی
- **Architecture Docs:** بهبود مستندات معماری و deployment

#### 🔧 بهبودهای فنی
- **ML Integration:** بهبود مدل‌های یادگیری ماشین
  - Multi-horizon analysis
  - Pattern classification
  - Feature extraction پیشرفته
- **API Enhancement:** توسعه REST API با endpoints جدید
- **Security:** بهبود middleware امنیتی و rate limiting

### 📊 آمار پروژه
- **پوشش تست:** 76.28% (حفظ سطح کیفیت)
- **تعداد فایل‌ها:** 252 فایل تغییر یافته
- **Lines of Code:** 35,104 اضافه شده / 15,109 حذف شده
- **سازگاری:** کاملاً backward compatible

### 🔄 تغییرات فایل‌ها

#### اضافه شده ➕
- `src/gravity_tech/` - ساختار اصلی پروژه
- `database/` - سیستم دیتابیس کامل
- `docs/releases/` - Release notes
- `docs/architecture/` - مستندات معماری
- `tests/unit/` - 13 فایل تست جدید
- `tests/benchmark/` - Benchmark tests
- `scripts/` - Utility scripts

#### تغییر یافته 🔄
- Migration کامل به `src/` structure
- بروزرسانی 50+ فایل موجود
- بهبود configuration files

#### حذف شده ➕
- فایل‌های deprecated از root
- مستندات تکراری
- فایل‌های تست قدیمی

### 🐛 رفع مشکلات شناخته شده
- بهبود handling edge cases در indicators
- رفع memory leaks در ML models
