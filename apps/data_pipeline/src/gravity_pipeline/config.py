...
class PipelineEnvironmentConfig:
    ...
    # Data sources
    TSE_API_BASE_URL: str = os.getenv("TSE_API_BASE_URL", "https://api.tse.ir/api")

    # Database URLs
    SOURCE_DB_URL: str = os.getenv("SOURCE_DB_URL", "sqlite:///./data/gravity_source.db")

    TARGET_DB_URL: str = os.getenv("TARGET_DB_URL", "sqlite:///./data/gravity.db")
    ...
    TSE_API_KEY: str | None = os.getenv("TSE_API_KEY")
