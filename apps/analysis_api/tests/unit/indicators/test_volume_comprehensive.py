...
def generate_volume_candles(
    count: int = 50, base_price: float = 100.0, trend: str = "neutral"
) -> list[Candle]:
...
def generate_divergence_candles(
    volume_trend: str, price_trend: str, count: int = 30
) -> list[Candle]:
