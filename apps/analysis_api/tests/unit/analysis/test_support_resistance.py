...
class TestPivotPoints:
    ...
    def test_pivot_points_woodie(self, sample_candles):
        ...
        result = SupportResistanceIndicators.pivot_points(sample_candles, method="woodie")
    ...
    def test_pivot_points_fibonacci(self, sample_candles):
        ...
        result = SupportResistanceIndicators.pivot_points(sample_candles, method="fibonacci")
...
class TestFibonacciRetracement:
    ...
    def test_fibonacci_downtrend(self, downtrend_candles):
        ...
        result = SupportResistanceIndicators.fibonacci_retracement(downtrend_candles)
...
class TestSupportResistanceLevels:
    ...
    def test_sr_levels_detection(self, sample_candles):
        ...
        result = SupportResistanceIndicators.support_resistance_levels(
            sample_candles, window=5, num_touches=2
        )
    ...
    def test_sr_levels_with_touches(self):
        ...
        prices = [105, 103, 101, 100, 102, 104, 102, 100, 103, 105, 103, 101, 100, 102, 104]
        ...
        result = SupportResistanceIndicators.support_resistance_levels(
            candles, window=3, num_touches=2
        )
...
class TestDynamicSupportResistance:
    ...
    def test_dynamic_sr_signal(self, sample_candles):
        ...
        result = SupportResistanceIndicators.dynamic_support_resistance(sample_candles)
...
class TestKeyLevels:
    ...
    def test_key_levels_round_numbers(self):
        ...
        result = SupportResistanceIndicators.identify_key_levels(candles, lookback=50)
...
class TestBreakoutDetection:
    ...
    def test_breakout_resistance(self):
        ...
        result = SupportResistanceIndicators.detect_breakout(candles, window=20)
...
class TestZoneDetection:
    ...
    def test_zone_width(self, sample_candles):
        ...
        result_narrow = SupportResistanceIndicators.detect_zones(sample_candles, zone_width=0.01)
        result_wide = SupportResistanceIndicators.detect_zones(sample_candles, zone_width=0.05)
...
class TestPriceAction:
    ...
    def test_price_action_at_support(self, sample_candles):
        ...
        result = SupportResistanceIndicators.price_action_at_level(
            sample_candles, level=100.0, tolerance=0.01
        )
    ...
    def test_price_action_at_resistance(self, sample_candles):
        ...
        result = SupportResistanceIndicators.price_action_at_level(
            sample_candles, level=110.0, tolerance=0.01
        )
