...
class TestFibonacciTools:
    ...
    def test_calculate_fans_custom_ratios(self, fib_tools):
        ...
        result = fib_tools.calculate_fans(
            origin_point, high_point, time_point, ratios=custom_ratios
        )
    ...
    def test_calculate_projections_custom_ratios(self, fib_tools):
        ...
        result = fib_tools.calculate_projections(
            wave1_start, wave1_end, wave2_end, ratios=custom_ratios
        )
    ...
    def test_analyze_fibonacci_confluence_no_confluence(self, fib_tools):
        ...
        result = fib_tools.analyze_fibonacci_confluence(
            levels, Decimal("125.0"), tolerance=Decimal("0.01")
        )
    ...
    def test_analyze_fibonacci_confluence_multiple_confluence(self, fib_tools):
        ...
        result = fib_tools.analyze_fibonacci_confluence(
            levels, Decimal("125.0"), tolerance=Decimal("0.05")
        )
