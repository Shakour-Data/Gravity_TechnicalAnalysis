...
class PatternTestData:
    ...
    def head_and_shoulders() -> List[Dict]:
        ...
        return [
            ...
            PatternTestData.create_candle(base_date + timedelta(days=8), 105, 108, 102, 103),
        ]
    ...
    def double_bottom() -> List[Dict]:
        ...
        return [
            ...
            # Breakout
            PatternTestData.create_candle(base_date + timedelta(days=5), 92, 105, 90, 103),
        ]
    ...
    def uptrend() -> List[Dict]:
        ...
        for day in range(20):
            ...
            candles.append(PatternTestData.create_candle(
