    ...
    [
        (
            "Ideal conditions - Strong and confident signal",
            {
                ...
                "momentum": [
                    create_indicator(
                        "RSI", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.9
                    ),
                    create_indicator(
                        "Stoch", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.9
                    ),
                ],
                "cycle": [
        ...
        (
            "Uncertainty - Accurate indicators with different signals",
            {
                ...
                "momentum": [
                    ...
                    create_indicator(
                        "Stoch", IndicatorCategory.MOMENTUM, SignalStrength.BEARISH, 0.9
                    ),
                ],
                "cycle": [
        ...
        (
            "Rely on trend - Other indicators uncertain",
            {
                ...
                "momentum": [
                    create_indicator(
                        "RSI", IndicatorCategory.MOMENTUM, SignalStrength.NEUTRAL, 0.3
                    ),
                    create_indicator(
                        "Stoch", IndicatorCategory.MOMENTUM, SignalStrength.BEARISH, 0.2
                    ),
                ],
                "cycle": [
        ...
        (
            "Possible trend change - Momentum and cycle giving change signals",
            {
                ...
                "momentum": [
                    create_indicator(
                        "RSI", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.95
                    ),
                    create_indicator(
                        "Stoch", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.9
                    ),
                ...
                "cycle": [
                    create_indicator("Sine", IndicatorCategory.CYCLE, SignalStrength.BULLISH, 0.9),
                    create_indicator(
                        "Phase", IndicatorCategory.CYCLE, SignalStrength.BULLISH, 0.95
                    ),
                ],
                "volume": [
        ...
        (
            "Uncertain market - All indicators uncertain",
            {
                ...
                "momentum": [
                    create_indicator(
                        "RSI", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.3
                    ),
                    create_indicator(
                        "Stoch", IndicatorCategory.MOMENTUM, SignalStrength.BULLISH, 0.3
                    ),
                ],
                "cycle": [
...
def test_scenario(title: str, indicators: dict):
    ...
    print(
        f"  Momentum:  {len(indicators['momentum'])} indicators, avg accuracy: {momentum_acc:.2f}"
    )
