...
class APITestClient:
    ...
    async def _handle_analyze(self, data: dict) -> dict:
        ...
        return {
            ...
            "signal": "BUY",
            "confidence": 75.5,
            "indicators": {"sma_20": 100.5, "rsi": 65.0, "macd": 0.5},
        }
...
class TestAnalyzeEndpoint:
    ...
    async def test_analyze_multiple_candles(self, api_client):
        ...
        candles = [{"close": 100.0 + i * 0.1} for i in range(100)]

        request = {"symbol": "TEST", "candles": candles}
    ...
    async def test_analyze_special_characters_in_symbol(self, api_client):
        ...
        request = {"symbol": "!@#$%^&*()", "candles": [{"close": 100}]}
...
class TestPatternsEndpoint:
    ...
    async def test_patterns_valid_request(self, api_client):
        ...
        request = {"symbol": "BTCUSDT", "candles": [{"close": 100}]}
...
class TestConcurrentRequests:
    ...
    async def test_multiple_concurrent_analyze_requests(self, api_client):
        ...
        requests = [{"symbol": f"TEST{i}", "candles": [{"close": 100 + i}]} for i in range(5)]
