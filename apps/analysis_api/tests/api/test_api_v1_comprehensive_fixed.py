...
def sample_candles() -> list[CandleData]:
    ...
    for i in range(200):  # Increased to 200 candles for comprehensive testing
        candles.append(
            CandleData(
                timestamp=int(base_time.timestamp()) + i * 3600,  # Unix timestamp
                open=100 + i * 0.5,
                high=105 + i * 0.5,
                low=95 + i * 0.5,
                close=102 + i * 0.5,
...
class TestHistoricalAnalysisEndpoints:
    ...
    def test_historical_request_minimal(self):
        ...
        request = HistoricalAnalysisRequest(
            symbol="BTCUSDT", timeframe="1h", start_date=None, end_date=None, limit=100
        )
    ...
    def test_historical_request_custom_limit(self):
        ...
        request = HistoricalAnalysisRequest(
            symbol="ETHUSDT", timeframe="4h", start_date=None, end_date=None, limit=250
        )
    ...
    def test_historical_multiple_requests(self):
        ...
        for symbol in symbols:
            for timeframe in timeframes:
                request = HistoricalAnalysisRequest(
                    symbol=symbol, timeframe=timeframe, start_date=None, end_date=None, limit=100
                )
...
class TestPatternDetectionEndpoints:
    ...
    def test_pattern_request_minimal(self, sample_candles):
        ...
        request = PatternDetectionRequest(candles=sample_candles, symbol="BTCUSDT", timeframe="1d")
        assert request.symbol == "BTCUSDT"
        assert request.timeframe == "1d"
        assert len(request.candles) == 200
...
class TestToolRecommendationEndpoints:
    ...
    def test_tool_recommendation_request_minimal(self):
        ...
        request = ToolRecommendationRequest(symbol="BTCUSDT")
        assert request.symbol == "BTCUSDT"

    def test_tool_recommendation_request_with_context(self):
        """Test tool recommendation with analysis goal"""
        request = ToolRecommendationRequest(symbol="ETHUSDT", timeframe="1h", top_n=10)
    ...
    def test_tool_recommendation_multiple_scenarios(self):
        ...
        for style in styles:
            request = ToolRecommendationRequest(symbol="BTCUSDT", trading_style=style)
            assert request.symbol == "BTCUSDT"
...
class TestAPIIntegration:
    ...
    def test_workflow_historical_then_patterns(self, sample_candles):
        ...
        pattern_request = PatternDetectionRequest(
            symbol="BTCUSDT", timeframe="1h", candles=sample_candles
        )
        ...
        for symbol in symbols:
            requests.append(
                HistoricalAnalysisRequest(
                    symbol=symbol, timeframe="1h", start_date=None, end_date=None, limit=100
                )
            )
...
class TestAPIRequestValidation:
    ...
    def test_historical_request_validation_symbol(self):
        ...
        request = HistoricalAnalysisRequest(
            symbol="VALIDTOKEN", timeframe="1h", start_date=None, end_date=None, limit=100
        )
    ...
    def test_historical_request_validation_limit(self):
        ...
        # Valid limit
        request = HistoricalAnalysisRequest(
            symbol="BTCUSDT", timeframe="1h", start_date=None, end_date=None, limit=500
        )
...
class TestAPIPerformance:
    ...
    def test_large_limit_request(self):
        ...
        request = HistoricalAnalysisRequest(
            symbol="BTCUSDT", timeframe="1h", start_date=None, end_date=None, limit=1000
        )
