...
async def pattern_service_health():
    ...
    model_v2_path = ML_MODELS_DIR / "pattern_classifier_advanced_v2.pkl"
...
def _load_pattern_model():
    ...
    candidates = [
        ("v2", ML_MODELS_DIR / "pattern_classifier_advanced_v2.pkl"),
        ("v1", ML_MODELS_DIR / "pattern_classifier_v1.pkl"),
    ]
