...
- **توجه: وزن‌دهی با یادگیری ماشین برای بهبود دقت تصمیم‌گیری ضروری است.**
...
## پرونده ارائه به کارفرما (دقیق و یکپارچه)
- `docs/dossier/INDEX.md` - پرونده فنی کامل + دیاگرام‌ها + الگوریتم‌ها/اندیکاتورها (برای ارائه سازمانی/دانش‌بنیان)
