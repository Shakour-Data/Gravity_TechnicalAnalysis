...
- [ ] بروزرسانی ../guides/QUICK_START_10_DAYS.md (ردیف ۱۲۶)
...
- ✅ لازم است تست‌های اضافی اضافه شوند (../reports/CRITICAL_PRIORITY_ANALYSIS.md)
...
- ../reports/CRITICAL_PRIORITY_ANALYSIS.md (ردیف‌های 15-67, 346)
- docs/releases/RELEASE_NOTES_v1.3.0.md (ردیف‌های 661-707)
- ../guides/QUICK_START_10_DAYS.md (ردیف 126)
